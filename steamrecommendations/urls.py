"""
URL configuration for steamrecommendation project.
...
urlpatterns = [
    ...
    path('recommendations/personalized/', views.personalized_recommendations_view, name="personalized_recommendations_view"),
    path('search/', views.search_games, name="search_games"),
    path('ajax/search_games/', views.ajax_search_games, name='ajax_search_games'), # AJAX search for survey
